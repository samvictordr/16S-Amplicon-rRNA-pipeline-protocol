...
This license applies only to original work authored by the project
contributors. Third-party software, databases, sequence data, and other
external materials remain subject to their respective licenses and terms.

The sequence data used in this study were generated by Jorissen et al. (2021)
and are publicly available through the European Nucleotide Archive (ENA) under
study accession PRJEB33591 and the applicable ENA terms.
